# Contributing to Soenneker.Utils.Method
...
1. **Create an Issue**
   - If you have a new feature idea, a bug report, or any other improvement suggestion, start by creating an issue on the [Issues](https://github.com/soenneker/soenneker.utils.method/issues) page.
...
3. **Clone the Repository**
   - Clone the repository to your local machine using the following command:
     ```
     git clone https://github.com/soenneker/soenneker.utils.method.git
     ```
...
9. **Create a Pull Request (PR)**
   - Go to the [Pull Requests](https://github.com/soenneker/soenneker.utils.method/pulls) page of the original repository.
...
Thank you for contributing to Soenneker.Utils.Method!
